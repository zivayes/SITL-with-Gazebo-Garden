...
{
  unsigned int fdm_port_in = this->dataPtr->fdm_port_in;
  unsigned int fdm_port_out = this->dataPtr->fdm_port_out;
  ...
  getSdfParam<uint32_t>(_sdf, "fdm_port_in",
                         fdm_port_in, 9002);
  getSdfParam<uint32_t>(_sdf, "fdm_port_out",
                        fdm_port_out, 9003);
